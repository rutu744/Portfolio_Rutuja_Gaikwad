      ...
      <div className="container mx-auto px-4 z-10">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="text-2xl md:text-3xl text-gray-600 mb-8 animate-fade-in delay-100">
            <span className="typing-text">Web Developer & Designer</span>
          </h2>
          
          <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto animate-fade-in delay-200">
            I create beautiful, functional websites and digital experiences that help businesses grow and succeed online.
          </p>
